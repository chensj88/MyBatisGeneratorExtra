...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_DELETE_BY_SELECTIVE_KEY_STATEMENT_ID,
        ATTR_SELELCT_BY_SELECTIVE_KEY_STATEMENT_ID,
        ATTR_SELELCT_BY_SELECT_ALL_STATEMENT_ID,
        ATTR_COUNT_BY_SELECTIVE_KEY_STATEMENT_ID,
     ...
     * 
    * @Title: initialize
    * @Description:  IntrospectedTable中属性设置
    * @param     参数
    * @return void    返回类型
    * @throws
     */
    ...
    * @throws
    ...
    protected void calculateXmlAttributes() {
        ...
        //TODO 扩展 自定义的SQLMAP
        setDeleteBySelectiveKeyStatementId("deleteBySelectiveKey"); 
        setSelectBySelectiveAllStatementId("selectBySelectiveAll");
        setSelectBySelectiveKeyStatementId("selectBySelectiveKey");
        setCountAllStatementId("countAll");
        setCountBySelectiveKeyStatementId("countBySelectiveKey");
    }
    ...
    /**
     * 
    * @Title: calculateJavaClientImplementationPackage
    * @Description: 计算java客户端文件继承的包
    * @param @return    参数
    * @return String    返回类型
    * @throws
     */
    ...
    /**
     * 生成接口文件所在的包名
    * @Title: calculateJavaClientInterfacePackage
    * @param @return    参数
    * @return String    返回类型
    * @throws
     */
    ...
    /**
     * 计算java mapper或dao文件的属性
    * @Title: calculateJavaClientAttributes
    * @return void    返回类型
    * @throws
     */
    ...
    /**
     * java entity生成属性配置
    * @Title: calculateModelAttributes
    * @param     参数
    * @return void    返回类型
    * @throws
     */
     ...
     * TODO 自定义参数设置区域
     */
    public void setDeleteBySelectiveKeyStatementId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_DELETE_BY_SELECTIVE_KEY_STATEMENT_ID, s);
    }
    public String getDeleteBySelectiveKeyStatementId() {
        return internalAttributes.get(InternalAttribute.ATTR_DELETE_BY_SELECTIVE_KEY_STATEMENT_ID);
    }
    
   public void setSelectBySelectiveAllStatementId(String s) {
	   internalAttributes.put(InternalAttribute.ATTR_SELECT_ALL_STATEMENT_ID, s);
   }
   
   public String getSelectBySelectiveAllStatementId() {
	   return internalAttributes.get(InternalAttribute.ATTR_SELECT_ALL_STATEMENT_ID);
   }
   
   public void setSelectBySelectiveKeyStatementId(String s) {
	   internalAttributes.put(InternalAttribute.ATTR_SELELCT_BY_SELECTIVE_KEY_STATEMENT_ID, s);
   }
   
   public String getSelectBySelectiveKeyStatementId() {
	   return internalAttributes.get(InternalAttribute.ATTR_SELELCT_BY_SELECTIVE_KEY_STATEMENT_ID);
   }
   
   public void setCountBySelectiveKeyStatementId(String s) {
	   internalAttributes.put(InternalAttribute.ATTR_COUNT_BY_SELECTIVE_KEY_STATEMENT_ID, s);
   }
   
   public String getCountBySelectiveKeyStatementId() {
	   return internalAttributes.get(InternalAttribute.ATTR_COUNT_BY_SELECTIVE_KEY_STATEMENT_ID);
   }
   
   public void setCountAllStatementId(String s) {
	   internalAttributes.put(InternalAttribute.ATTR_COUNT_ALL_STATEMENT_ID, s);
   }
   
   public String getCountAllStatementId() {
	   return internalAttributes.get(InternalAttribute.ATTR_COUNT_ALL_STATEMENT_ID);
   }
