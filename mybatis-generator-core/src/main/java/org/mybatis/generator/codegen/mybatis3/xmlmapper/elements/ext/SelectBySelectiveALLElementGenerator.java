...
*
 */
public class SelectBySelectiveALLElementGenerator extends
        AbstractXmlElementGenerator {


    public SelectBySelectiveALLElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", introspectedTable.getSelectBySelectiveAllStatementId())); //$NON-NLS-1$
        //指定参数类型
