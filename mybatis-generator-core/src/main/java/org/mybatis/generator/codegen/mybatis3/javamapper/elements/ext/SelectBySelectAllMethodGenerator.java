...
*
 */
public class SelectBySelectAllMethodGenerator extends
        AbstractJavaMapperMethodGenerator {


    public SelectBySelectAllMethodGenerator(boolean isSimple) {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getSelectBySelectiveAllStatementId());
