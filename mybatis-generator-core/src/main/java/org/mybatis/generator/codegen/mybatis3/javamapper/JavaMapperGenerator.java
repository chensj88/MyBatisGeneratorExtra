...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.ext.CountAllMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.ext.CountBySelectKeyMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.ext.DeleteBySelectKeyMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.ext.SelectBySelectAllMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.ext.SelectBySelectKeyMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        //TODO java mapper class 生成方法配置区域
        //自定义删除
        addDeleteBySelectKeyMethod(interfaze);
        addSelectBySelectAllMethod(interfaze);
        addSelectBySelectKeyMethod(interfaze);
        addCountBySelectAllMethod(interfaze);
        addCountBySelectKeyMethod(interfaze);
    ...
    /**
     * 增加按照key来删除
    * @Title: addDeleteBySelectKeyMethod
    * @throws
     */
    protected void addDeleteBySelectKeyMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateDeleteByPrimaryKey()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new DeleteBySelectKeyMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    
    protected void addCountBySelectKeyMethod(Interface interfaze) {
		 AbstractJavaMapperMethodGenerator methodGenerator = new CountBySelectKeyMethodGenerator(false);
         initializeAndExecuteGenerator(methodGenerator, interfaze);
	}

    protected void addCountBySelectAllMethod(Interface interfaze) {
		 AbstractJavaMapperMethodGenerator methodGenerator = new CountAllMethodGenerator();
         initializeAndExecuteGenerator(methodGenerator, interfaze);
	}

    protected void addSelectBySelectKeyMethod(Interface interfaze) {
		 AbstractJavaMapperMethodGenerator methodGenerator = new SelectBySelectKeyMethodGenerator(false);
         initializeAndExecuteGenerator(methodGenerator, interfaze);
	}

    protected void addSelectBySelectAllMethod(Interface interfaze) {
		 AbstractJavaMapperMethodGenerator methodGenerator = new SelectBySelectAllMethodGenerator(false);
         initializeAndExecuteGenerator(methodGenerator, interfaze);
	}
