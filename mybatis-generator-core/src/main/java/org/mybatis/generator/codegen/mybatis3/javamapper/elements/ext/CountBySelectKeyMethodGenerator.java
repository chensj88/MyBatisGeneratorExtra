...
*
 */
public class CountBySelectKeyMethodGenerator extends
        AbstractJavaMapperMethodGenerator {


    public CountBySelectKeyMethodGenerator(boolean isSimple) {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getCountBySelectiveKeyStatementId());
