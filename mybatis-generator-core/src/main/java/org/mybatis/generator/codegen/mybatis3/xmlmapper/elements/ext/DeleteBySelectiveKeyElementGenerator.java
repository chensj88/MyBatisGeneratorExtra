...
*
 */
public class DeleteBySelectiveKeyElementGenerator extends
        AbstractXmlElementGenerator {


    public DeleteBySelectiveKeyElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", introspectedTable.getDeleteBySelectiveKeyStatementId())); //$NON-NLS-1$
        //指定参数类型
