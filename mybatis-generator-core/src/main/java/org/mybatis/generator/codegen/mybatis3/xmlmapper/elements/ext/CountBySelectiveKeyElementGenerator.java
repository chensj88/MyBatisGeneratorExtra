...
*
 */
public class CountBySelectiveKeyElementGenerator extends
        AbstractXmlElementGenerator {


    public CountBySelectiveKeyElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", introspectedTable.getCountBySelectiveKeyStatementId())); //$NON-NLS-1$
        //指定参数类型
