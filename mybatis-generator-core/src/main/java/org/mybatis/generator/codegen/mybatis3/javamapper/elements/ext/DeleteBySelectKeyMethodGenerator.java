...
*
 */
public class DeleteBySelectKeyMethodGenerator extends
        AbstractJavaMapperMethodGenerator {


    public DeleteBySelectKeyMethodGenerator(boolean isSimple) {
        super();
    }
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(introspectedTable.getDeleteBySelectiveKeyStatementId());
