...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ext.CountALLElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ext.CountBySelectiveKeyElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ext.DeleteBySelectiveKeyElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ext.SelectBySelectiveALLElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ext.SelectBySelectiveKeyElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        //TODO XML生成的方法配置区域
        //扩展使用自定义来完成删除
        addDeleteBySelectiveKeyElement(answer);
        addCountBySelectiveKeyElement(answer);
        addCountALLElement(answer);
        addSelectBySelectiveALLElement(answer);
        addSelectBySelectiveKeyElement(answer);
        return answer;
    }
    ...
    /**
     * 
    * @Title: addDeleteBySelectiveKeyElement
    * @throws
     */
    protected void addDeleteBySelectiveKeyElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new DeleteBySelectiveKeyElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addCountBySelectiveKeyElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new CountBySelectiveKeyElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    ...
    protected void addSelectBySelectiveKeyElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new SelectBySelectiveKeyElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    protected void addSelectBySelectiveALLElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new SelectBySelectiveALLElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
}
